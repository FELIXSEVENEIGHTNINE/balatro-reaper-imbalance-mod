...
-- 12 | Wily Joker
SMODS.Joker:take_ownership ('wily', { order = 12, config = { t_chips = 100, type = 'Three of a Kind',}})

-- 13 | Clever Joker
SMODS.Joker:take_ownership ('clever', { order = 13, config = { t_chips = 80, type = 'Two Pair', }})

-- 14 | Devious Joker
SMODS.Joker:take_ownership ('devious', { order = 14, config = { t_chips = 100, type = 'Straight',}})

-- 15 | Crafty Joker
SMODS.Joker:take_ownership ('crafty', { order = 15, config = { t_chips = 80, type = 'Flush',}})
...
-- 24 | Marble Joker
SMODS.Joker:take_ownership ('marble', { order = 24, config = {extra = 1},}) 
...
-- 116 | Rough Gem
SMODS.Joker:take_ownership ('rough_gem', { order = 116, config = { extra = 3 },})

-- 117 | Bloodstone
SMODS.Joker:take_ownership ('bloodstone', { order = 117, config = { extra = { odds = 2, Xmult = 1.5, }},})

-- 118 | Arrowhead
SMODS.Joker:take_ownership ('arrowhead', { order = 118, config = { extra = 100 },})

-- 119 | Onyx Agate
SMODS.Joker:take_ownership ('onyx_agate', { order = 119, config = { extra = 35 },})
