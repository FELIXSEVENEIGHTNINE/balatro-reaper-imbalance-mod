...
--         if v.suit ~= G.GAME.current_round.ancient_card.suit then 
--             ancient_suits[#ancient_suits + 1] = v 
--         end
--     end

--     if #ancient_suits == 0 then
...
-- Ancient Joker Fix
-- https://github.com/gabepesco/BalatroAncientJokerFix/blob/main/AncientJokerFix.lua
function reset_ancient_card()
    G.GAME.current_round.ancient_card.suit = 'Spades'
...
function generate_card_ui(_c, full_UI_table, specific_vars, card_type, badges, hide_desc, main_start, main_end)
    ...
    elseif _c.set == 'Enhanced' then 
        ...
        elseif _c.effect == 'Lucky Card' then 
            loc_vars = {G.GAME.probabilities.normal, _c.config.mult, 4, _c.config.p_dollars, 8}
        end
        localize{type = 'descriptions', key = _c.key, set = _c.set, nodes = desc_nodes, vars = loc_vars}
